...
CREATE TABLE player_information(
  ...
  pi_created_by INT,
  pi_updated_at TIMESTAMP DEFAULT NOW(),
  pi_updated_by INT,
  PRIMARY KEY (pi_id)
);
...
-- Function for pi_updated_at 
CREATE FUNCTION trigger_pi_updated_at()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE TRIGGER set_pi_timestamp
BEFORE
UPDATE ON player_information
FOR EACH ROW
...
CREATE TABLE game_data(
  ...
  gd_created_by INT,
  gd_updated_at TIMESTAMP DEFAULT NOW(),
  gd_updated_by INT,
  PRIMARY KEY (gd_id)
);
...
CREATE TABLE game_information(
  ...
  gi_created_by INT,
  gi_updated_at TIMESTAMP DEFAULT NOW(),
  gi_updated_by INT,
  PRIMARY KEY (gi_id),
...
CREATE TABLE game_galleries(
  ...
  ggs_created_by INT,
  ggs_updated_at TIMESTAMP DEFAULT NOW(),
  ggs_updated_by INT,
  PRIMARY KEY (ggs_id),
...
CREATE TABLE game_costs(
  ...
  gcs_created_by INT,
  gcs_updated_at TIMESTAMP DEFAULT NOW(),
  gcs_updated_by INT,
  PRIMARY KEY (gcs_id),
...
CREATE TABLE game_registration(
  ...
  gr_created_by INT,
  gr_updated_at TIMESTAMP DEFAULT NOW(),
  gr_updated_by INT,
  PRIMARY KEY (gr_id),
...
CREATE TABLE game_registered_player(
  ...
  grp_created_by INT,
  grp_updated_at TIMESTAMP DEFAULT NOW(),
  grp_updated_by INT,
  PRIMARY KEY (grp_id),
